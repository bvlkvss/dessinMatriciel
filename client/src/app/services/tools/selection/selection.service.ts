...
*/
  ...
  */
      /*
           if (this.resizingHandles[5].x >= this.selectionEndPoint.x) {
             switch (this.currenthandle) {
               case 6:
                 this.selectionEndPoint = this.resizingHandles[5];
                 this.currenthandle = 8;
           ...
           else if (this.resizingHandles[7].x <= this.selectionStartPoint.x) {
             switch (this.currenthandle) {
               case 8:
           ...
           if (this.resizingHandles[6].y <= this.selectionStartPoint.y) {
           ...
           else if (this.resizingHandles[1].y >= this.selectionEndPoint.y) {
     ...
     */
      /*   if(this.currentPos.x<this.selectionStartPoint.x){
           console.log("negative");
     
           if(this.currenthandle==8){
             this.currenthandle=6;
             this.selectionStartPoint.x=this.currentPos.x;
     
           }
           else if(this.currenthandle==5){
             this.currenthandle=4;
             this.selectionStartPoint.x=this.currentPos.x;
     
           }
         }
         else if(this.currentPos.x>this.selectionStartPoint.x){
           
           console.log("positive");
           if(this.currenthandle==6){
             this.currenthandle=8;
             this.selectionStartPoint.x=this.selectionEndPoint.x;
             this.selectionEndPoint.x=this.currentPos.x;
             //this.selectionStartPoint.x=this.selectionEndPoint.x-this.width;
           }
           else if(this.currenthandle==4){
             this.currenthandle=5;
             this.selectionStartPoint.x=this.selectionEndPoint.x;
             this.selectionEndPoint.x=this.currentPos.x;
             //this.selectionStartPoint.x=this.selectionEndPoint.x-this.width;
