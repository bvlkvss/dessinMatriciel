...
describe('EllipseService', () => {
    ...
    it('onMouseOut should not set isOut to true if mouseDown is not true', () => {
    ...
    it('onMouseOut should not call drawEllipse if mouseDown is false', () => {
        service.mouseDown = false;
        service.onMouseOut(mouseEvent);
    ...
    it('onMouseUp should not call drawEllipse if mouse is not down', () => {
        service.mouseDown = false;
    ...
    it('if mouse is out onMouseUp should  call drawEllipse with mouseOutCoords', () => {
        ...
        service.isOut = true;
        service.onMouseUp(mouseEvent);
        expect(drawEllipseSpy).toHaveBeenCalledWith(service['drawingService'].baseCtx, service.mouseDownCoord, service.mouseOutCoord, false, false);
    });
    ...
    it('onKeyUp should not call drawEllipse if shift is pressed', () => {
        service.mouseDown = true;
        const event = new KeyboardEvent('document:keydown', {
            key: 'Shift',
            shiftKey: true,
